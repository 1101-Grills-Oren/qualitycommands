...
import net.minecraft.server.function.CommandFunctionManager;
import net.minecraft.nbt.NbtCompound;
public abstract interface EnderDragonEntityAccessor {
    
	public abstract int setTicksUntilNextGrowl(int ticks);
    public abstract int getTicksUntilNextGrowl();
    public abstract void runTickWithEndCrystals();
}
